/*
	Disnut - A better forum platform for the modern web
	https://github.com/Disnut/Disnut/
	Copyright (C) 2018 Disnut.
...
if (!process.send) {
	...
	winston.info('Disnut v' + nconf.get('version') + ' Copyright (C) ' + (new Date()).getFullYear() + ' Disnut.');
