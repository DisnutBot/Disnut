...
before(function (done) {
	...
	async.series([
		...
		function (next) {
			...
			nconf.set('base_templates_path', path.join(nconf.get('themes_path'), 'nodebb-theme-disnut/templates'));
			nconf.set('theme_templates_path', meta.config['theme:templates'] ? path.join(nconf.get('themes_path'), meta.config['theme:id'], meta.config['theme:templates']) : nconf.get('base_templates_path'));
			nconf.set('theme_config', path.join(nconf.get('themes_path'), 'nodebb-theme-disnut', 'theme.json'));
